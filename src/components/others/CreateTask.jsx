            ...
            <form className='flex flex-wrap w-full items-start justify-between'>
                <div className='w-1/2'>
                    ...
                    <div>
                        ...
                        <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type='text' placeholder='assign to' />
                    </div>
                    <div>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none border-[1px] border-gray-400' rows='10' cols='30' placeholder='Design a UI for a website' />
